...
from resources.user_new import User_new, User_modify, User_new_v


continuum = Continuum(db=db)
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:pqrs@localhost/application_db'
...
api.add_resource(User_new, '/user')#To get all users and create a user
api.add_resource(User_modify, '/update/<int:id>','/deleteuser/<int:id>','/getuser/<int:id>')#To update, get single user, delete a user

api.add_resource(User_new_v, '/user_v') #user version table
